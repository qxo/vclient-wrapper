 ...
 *
 */
public class DiskAvgReadPerfInfo extends PerformanceInfo {
	...
	public Map<Date, Long> getHistUsageData() {
		try {
			return getPerfValues(PerfMetricEnum.DISK_AVG_READ_REQ, ValueTypeEnum.RATE);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
